...
var url = "http://ip-api.com/json/?fields=9497371";
...
var message = ""
const paras = ["query","isp","as","country","countryCode","city","regionName","timezone"];
const paran = ["🐈查询IP","🐈ISP","🐈ASN","🐈国家","🐈国家代码","🐈城市","🐈区域","🐈时区"];

$httpClient.get(requestParams, (error, response, data) => {
    if (error) {
        message = "</br></br>🛑 查询超时"
        message = `<p style="text-align: center; font-family: -apple-system; font-size: large; font-weight: bold;">` + message + `</p>`
        $done({"title": "🔎 完成", "htmlMessage": message});
    } else {
        console.log(data);
...
function json2info(cnt, paras) {
    ...
    for (i = 0;i < paras.length; i ++) {
		...
		cnt[paras[i]] = paras[i] == "currency" ? cnt[paras[i]]  + " "+ flags.get(cnt["currency"].toUpperCase())  + "": cnt[paras[i]];
